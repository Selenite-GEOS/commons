<script>
	...
	$effect(() => {
		const interval = setInterval(addRandomContent, 100);
...
<div class="grid justify-center items-center">
	<textarea use:autosize={content} bind:value={content} class="w-[20rem] textarea textarea-bordered textarea-primary"></textarea>
</div>
